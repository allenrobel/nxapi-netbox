...
class NxapiBgpUnicastSummaryIpv4(NxapiBgpUnicastSummary):
    ...
    from nxapi_netbox.nxapi.nxapi_bgp_neighbors import NxapiBgpUnicastSummaryIpv4
...
class NxapiBgpUnicastSummaryIpv6(NxapiBgpUnicastSummary):
    ...
    from nxapi_netbox.general.log import get_logger
    from nxapi_netbox.nxapi.nxapi_bgp_neighbors import NxapiBgpUnicastSummaryIpv6
