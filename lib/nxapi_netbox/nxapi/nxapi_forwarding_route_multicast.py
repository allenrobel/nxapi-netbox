...
from nxapi_netbox.nxapi.nxapi_forwarding_route_multicast import NxapiForwardingRouteMulticastIpv4
...
my_username = 'admin'
my_password = 'foo'
my_switch_mgmt0_address = '1.1.1.1'
ipv4 = NxapiForwardingRouteMulticastIpv4(my_username,my_password,my_switch_mgmt0_address,log)
...
TODO: 20191113 - Wait for CSCvs07416 fix before working on this
'''
our_version = 101
...
class NxapiForwardingRouteMulticast(NxapiBase):
...
class NxapiForwardingRouteMulticastIpv4(NxapiForwardingRouteMulticast):
    '''
    Creates two items:
